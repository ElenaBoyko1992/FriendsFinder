...
46/ 95 урок.
К тегу <BrowserRouter> в App.tsx добавлен атрибут "basename={process.env.PUBLIC_URL}". Он необходима для корректной
работы урлов на разных хостингах (ghPages, localHost и т.д.). Более подробно - ~40 минута видео 