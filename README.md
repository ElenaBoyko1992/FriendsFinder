...
и если их не было, перезапускать селектор не будет. У сложных селекторов, созданных с пом. Reselect может быть несколько зависимостей.
Зависимостью является селектор (как примитивный, так и сложный). Библиотека Reselect вызывает селекторы, являющиеся зависимостями,
