...
! Настроить, чтобы при логауте сразу выкидывало на страницу логинизации (так уже настроено для сообщений) - done
! Проверить MyPosts (случайно пропустила) - done

!Бага со стрелочками в пагинаторе юзерсов - нужно убрать